        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Share your prompt-powered tool with our community. We&apos;ll
              review your submission and add it to our directory.
            </p>
          </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Upload a screenshot or preview of your product. Max
                          size: 10MB.
                        </p>
                      </div>
                    </div>
          ...
          <Card className="mt-8">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>
                • Your product should use AI, prompts, or automation to enhance
                user workflows.
              </p>
              ...
              <p>
                • Ensure your website is functional and provides adequate
                product information.
              </p>
              <p>
                • To prevent spam, we review all submissions manually and get
                your product in the list as soon as possible.
              </p>
            </CardContent>
          </Card>
        </div>
